 ...
 *
 * @orig Rob Scanlon
 * @see http://github.com/arscan/pleaserotate.js
 */
...
(function(){
    ...
    var options = {
        ...
        onShow: function(){},
        forcePortrait: false,
        message: "Por favor, gire el dispositivo",
        subMessage: "(El juego solo funciona en Landscape)",
    ...
    function orientationChanged(){
        ...
        forceLandscape.Showing = triggerOn;
    ...
    forceLandscape.start = function(opts){
        if(!document.body){
            window.addEventListener('load', forceLandscape.start.bind(null, opts), false);
            return;
        }
    ...
    forceLandscape.stop = function(){
        window.removeEventListener('resize', onWindowResize, false);
    }

    forceLandscape.onShow = function(fn){
        options.onShow = fn;
    ...
    forceLandscape.onHide = function(fn){
        options.onHide = fn;
